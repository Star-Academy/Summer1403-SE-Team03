...
public class SearchResultsFilterTest
{
    ...
    {
        List<string> atLeastOneResult = new List<string>() { "7000", "7001", "7002", "7003" };
        List<string> wordsShouldBeResult = new List<string>() { "7000" };
        List<string> wordsShouldNotBeResult = new List<string>() { "7003" };
    ...
    {
        List<string> atLeastOneResult = new List<string>() { "7000", "7001", "7003" };
        List<string> wordsShouldBeResult = new List<string>() {};
        List<string> wordsShouldNotBeResult = new List<string>() { "7003" };
    ...
    {
        List<string> atLeastOneResult = new List<string>() {};
        List<string> wordsShouldBeResult = new List<string>() { "7000" };
        List<string> wordsShouldNotBeResult = new List<string>() { "7003" };
        IEnumerable<string> expectedResult = new List<string>() { "7000" };
        var searchResult =new SearchResultsFilter();
